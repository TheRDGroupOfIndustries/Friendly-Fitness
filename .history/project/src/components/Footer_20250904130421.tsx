      ...
      <div className="relative z-10 max-w-4xl mx-auto px-2 sm:px-4 flex flex-col items-center">
        ...
        <div className="text-center mb-4 sm:mb-6 w-full">
          ...
          <div className="flex justify-center space-x-4 sm:space-x-6">
            <a href="" aria-label="Facebook" className="w-8 h-8 sm:w-10 sm:h-10 bg-white rounded-full flex items-center justify-center hover:bg-orange-500 transition-colors cursor-pointer focus:outline-none focus:ring-2 focus:ring-orange-500">
            ...
            <a href="#" aria-label="Instagram" className="w-8 h-8 sm:w-10 sm:h-10 bg-white rounded-full flex items-center justify-center hover:bg-orange-500 transition-colors cursor-pointer focus:outline-none focus:ring-2 focus:ring-orange-500">
