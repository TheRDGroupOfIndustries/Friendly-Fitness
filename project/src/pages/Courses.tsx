  ...
  return (
    <div className="bg-white min-h-screen">
        ...
        <div className="relative z-10 text-center text-white w-full px-4">
          <div className="flex flex-col items-center justify-center h-full">
            <div className="flex items-center justify-center mb-2">
              ...
              <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight">COURSES</h1>
              <span className="block w-8 h-1 bg-orange-500 ml-2"></span>
            </div>
            <h2 className="text-2xl md:text-3xl font-light mt-2">BUILDING A COMMUNITY OF ATHLETIC WOMEN</h2>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {filteredCourses.map((course, idx) => (
            <div key={idx} className="group relative overflow-hidden rounded-lg bg-white shadow-md">
              {/* Orange accent line */}
              ...
              <div className="p-6 text-center">
                <h3 className="text-2xl font-bold text-black mb-2 uppercase">{course.title}</h3>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="bg-orange-500 py-12 text-center relative">
        <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Fitness Classes This Summer.<br />Pay Now &amp; GET 35% Discount</h2>
        <button className="mt-4 px-10 py-4 rounded-full border-2 border-white text-white bg-transparent font-bold text-lg hover:bg-white hover:text-orange-500 transition-all duration-300">READ MORE</button>
      </section>
    </div>
  );
};
